## moveit_resources (rolling) - 3.2.1-1

The packages in the `moveit_resources` repository were released into the `rolling` distro by running `/usr/bin/bloom-release --rosdistro rolling --track rolling moveit_resources` on `Wed, 16 Sep 2026 18:10:18 -0000`
...
## moveit_resources (lyrical) - 3.2.1-1

The packages in the `moveit_resources` repository were released into the `lyrical` distro by running `/usr/bin/bloom-release --rosdistro lyrical --track lyrical moveit_resources` on `Wed, 16 Sep 2026 18:07:49 -0000`
...
## moveit_resources (lyrical) - 3.2.0-1

The packages in the `moveit_resources` repository were released into the `lyrical` distro by running `/usr/bin/bloom-release --ros-distro lyrical moveit_resources` on `Mon, 13 Jul 2026 14:36:15 -0000`
...
## moveit_resources (rolling) - 3.2.0-1

The packages in the `moveit_resources` repository were released into the `rolling` distro by running `/usr/bin/bloom-release --ros-distro rolling moveit_resources` on `Mon, 13 Jul 2026 14:32:49 -0000`
...
## moveit_resources (kilted) - 3.1.1-1

The packages in the `moveit_resources` repository were released into the `kilted` distro by running `/usr/bin/bloom-release --ros-distro kilted moveit_resources -e` on `Tue, 10 Jun 2025 11:47:47 -0000`
